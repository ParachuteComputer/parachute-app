  ...
  return (
    <>
      <button
        ...
        className={
          isPinned
            ? "min-h-11 rounded-lg border border-accent/60 bg-accent/10 px-3 py-1.5 text-sm text-accent hover:bg-accent/20 disabled:opacity-40"
            : "min-h-11 rounded-lg border border-border bg-card px-3 py-1.5 text-sm text-fg-muted hover:text-accent disabled:opacity-40"
        }
      >
        {isPinned ? "★ Pinned" : "☆ Pin"}
      </button>
      <button
        ...
        className={
          isArchived
            ? "min-h-11 rounded-lg border border-amber-500/40 bg-amber-500/10 px-3 py-1.5 text-sm text-amber-500 hover:bg-amber-500/20 disabled:opacity-40"
            : "min-h-11 rounded-lg border border-border bg-card px-3 py-1.5 text-sm text-fg-muted hover:text-accent disabled:opacity-40"
        }
      >
