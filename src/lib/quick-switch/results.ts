...
export const COMMANDS: Array<{
  ...
  },
  {
    ...
    action: { type: "navigate", to: "/notes?view=pinned" },
  },
  {
    id: "archived",
    label: "Archived",
    ...
    action: { type: "navigate", to: "/notes?view=archived" },
  },
  {
    id: "untagged",
    label: "Untagged",
    ...
    action: { type: "navigate", to: "/notes?view=untagged" },
  },
  {
    id: "orphaned",
    label: "Orphaned",
    ...
    action: { type: "navigate", to: "/notes?view=orphaned" },
  },
];
