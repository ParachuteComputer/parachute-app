...
**The round-two quality batch: saved views can be renamed in place, a crashed route recovers instead of taking the app down, code toggles stop leaving orphaned markers, and Tailwind stops shipping dead CSS.** Six PRs, every one independently reviewed pre-merge; zero must-fix escapes.
